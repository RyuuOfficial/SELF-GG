 ...
 * @returns true
 */
const addJcommands = (msg, response, userId, _data) => {
    const obj = {
        pesan: msg,
        balasan: response,
        creator: userId
    ...
    _data.push(obj)
    fs.writeFileSync('./lib/jcommands.json', JSON.stringify(_data))
 ...
 * @param {Object} _data
 */
const deleteJcommands = (command, _data) => {
...
const checkJcommands = (commands, _data) => {
    let status = false
    Object.keys(_data).forEach((i) => {
